...
Read the existing settings file before changing it. Merge new settings with existing ones — don't replace the whole file.

## Clarify ambiguity with AskUserQuestion

When the user's request is ambiguous, ask:
