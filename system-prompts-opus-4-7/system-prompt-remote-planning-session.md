...
When you've settled on an approach, call ExitPlanMode with a plan that's specific enough to implement without follow-up: which files, what changes, what order, how to verify. No filler.
